...
<main class="content">
        <div class="container-fluid p-0">
            ...
            <h1 class="h3 mb-3">Liste Des Employées</h1>
                    ...
                    <div class="card">
                        <div class="card-header">
                                <div class="col-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h5 class="card-title">Employées</h5>
                                            </div>
                                            <div class="card-body">
                            ...
                            <form action="{{Route("user.store")}}" method="post" id="frm" enctype="multipart/form-data">
                                        @csrf
                                            ...
                                            <div class="form-group required">
                                                    <label class="form-label">Titre de courtoisie</label>
                                                    <select name="titreC" id="input-titre" class="form-control">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <input class="form-control" type="date" name="datenais" />
                                            </div>
                                            <div class="form-group">
                                                    <label class="form-label">Date d'embauche</label>
                                                    <input class="form-control" type="date" name="dateemb" />
                                                </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                    <label class="form-label">Rend compte</label>
                                                    <input type="number" class="form-control" name="rcompte">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label class="form-label w-100">Photo</label>
                                                ...
                                                <table id="datatables-buttons" class="table table-striped table-bordered" style="width:100%">
                                                    ...
                                                    @foreach($users as $user)
                                                        <tr>
                                                            <td>{{ $user->id }}</td>
                                                            <td>
<img src="{{asset('storage/'.$user->photo)}}" class="img-thumbnail rounded" style="width: 80px;height: 50px;">
                                                            </td>
                                                            <td>{{ $user->nom_employe }}</td>
                                                            <td>{{ $user->prenom_employe }}</td>
                                                            <td>{{ $user->tel_domicile }}</td>
                                                            <td>{{ $user->email }}</td>
                                                            <td>
                                                                <a href="#" 
                                                            ...
                                                            <td>
                                                            <form id="fr{{$cnt}}" onsubmit="return false;" action="{{ route('user.destroy', ['id' => $user->id]) }}" method="post">
                                                                @csrf 
                                                                @method('delete')
